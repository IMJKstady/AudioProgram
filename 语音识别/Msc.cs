...
namespace MscAudio {
    ...
    internal class Msc {
        ...
        /// <returns></returns>
        [DllImport("msc_x64", CallingConvention = CallingConvention.StdCall)]
        public static extern IntPtr QTTSSessionBegin(string @params, out ErrorCode errorCode);
        ...
        /// <returns></returns>
        [DllImport("msc_x64", CallingConvention = CallingConvention.StdCall)]
        public static extern ErrorCode QTTSTextPut(IntPtr sessionID, string textString, uint textLen, string @params);
        ...
        /// <returns></returns>
        [DllImport("msc_x64", CallingConvention = CallingConvention.StdCall)]
        public static extern IntPtr QTTSAudioGet(IntPtr sessionID, out uint audioLen, out SynthStatus synthStatus, out ErrorCode errorCode);
